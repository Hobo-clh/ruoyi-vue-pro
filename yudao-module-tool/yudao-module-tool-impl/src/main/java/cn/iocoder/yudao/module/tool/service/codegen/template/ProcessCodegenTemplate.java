 ...
 * @date 2022/3/4
 */
public class ProcessCodegenTemplate {

    /**
     * 前缀
     */
    private static final String FILE_PATH_PREFIX = "process";

    public static final Map<String, String> MAP = MapUtil.<String, String>builder(new LinkedHashMap<>())
            ...
            .put(javaTemplatePath("listener/listener"),
                    javaModuleImplMainFilePath("listener/${table.businessName}/${table.className}ResultListener"))
            ...
            // SQL
            .put(FILE_PATH_PREFIX + "/sql/sql.vm", "sql/sql.sql")
            .build();
